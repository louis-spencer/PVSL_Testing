...
# Modified script with matplotlib functionality to graph sensor data.
#-----------------------------------------------------------------------
...
class MainWindow_ui(object):
    ...
    def setupUi(self, MainWindow):
        ...
        self.controls_settings_tab.setStyleSheet("QPushButton#reset_stop {\n"
                                                 "    color: red;    \n"
                                                 "}")
        ...
        self.duration_combobox.setObjectName("duration")
